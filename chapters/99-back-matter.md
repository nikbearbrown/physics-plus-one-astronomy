...
**Nik Bear Brown** teaches AI, data science, computational thinking, and visualization at Northeastern University. His doctoral work at UCLA was in computational and systems biology, with secondary fields in AI and statistics; the quantitative and observational disciplines that underlie astronomy share much of that toolkit.

He is the founder of [Humanitarians AI](https://www.humanitarians.ai/), the architect of the **Brutalist** AI-assisted production system, and the author of the *with LLMs* textbook series. He also writes the in-progress *Intelligence?*, a natural history of cognition that — in its later chapters — touches the same questions of scale and time that astronomy asks of physical systems.
